...
def buildsys_gowin(project):
    ...
    makefile_data.append(f"	nextpnr-gowin --seed 0 --json $(PROJECT).json --write $(PROJECT)_pnr.json --freq {float(project['jdata']['clock']['speed']) / 1000000} --enable-globals --enable-auto-longwires --device $(DEVICE) --cst pins.cst")
    makefile_data.append("")
